    ...
    if (!empty($data->{'user_id'}) && !empty($data->{'vote'}) && !empty($_SESSION['id'])) {
        ...
        if ($req) {
            ...
            if ($req) {
                ...
                $notify['id'] = $voted;
                $notify['body'] = "<a onclick='notifRedirect(event, this);' href='/".$pathurl."/profile?u=".urlencode($username)."'>".$username."</a> <b>liked</b> your profile";
                ...
                if ($like)
                    $notify['body'] = "<b>Match! </b><a onclick='notifRedirect(event, this);' href='/".$pathurl."/profile?u=".urlencode($username)."'>" . $username . "</a> <b>liked</b> your profile back! You can now <b>message eachother</b>!";
                ...
                if (has_voted($db, $voter, $voted, $vote) === 0)
                    ...
                    if ($vote == -1){
                        ...
                        if ($like) {
                            $notify['body'] = "You matched with <a onclick='notifRedirect(event, this);' href='/".$pathurl."/profile?u=".urlencode($username)."'>".$username."</a> but he <b>unliked</b> your profile... :(";
